...
// Grammar:
//   nam_console [map]
//     --map <path>   --debug   --plain
//     --no-color     --no-animation
//     --help         --version
//
// Unknown options, a missing --map value, or a positional map combined with
// --map are rejected as usage errors (exit code 2). NO_COLOR and TERM=dumb turn
// colour off; an explicit CLI flag always wins over the environment.
